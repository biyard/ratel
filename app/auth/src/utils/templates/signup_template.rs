// Source-of-truth for SES template sync (template name: signup_code).
// This file is not used at runtime in app/auth.
// Keep this in sync with the template you update directly in AWS SES.
