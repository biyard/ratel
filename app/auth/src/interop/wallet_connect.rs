...
pub async fn wallet_connect() -> common::Result<WalletConnectResult> {
...
pub async fn wallet_sign_message(message: &str) -> common::Result<String> {
...
pub async fn wallet_get_address() -> common::Result<Option<String>> {
...
pub async fn wallet_disconnect() -> common::Result<()> {
