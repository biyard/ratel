...
translate! {
    ...
    kpi_scheduled: { en: "Scheduled", ko: "예약" },
    kpi_draft: { en: "Drafts", ko: "초안" },

    tab_all: { en: "All", ko: "전체" },
    tab_live: { en: "Live", ko: "LIVE" },
    tab_scheduled: { en: "Scheduled", ko: "예약" },
    tab_draft: { en: "Drafts", ko: "초안" },
