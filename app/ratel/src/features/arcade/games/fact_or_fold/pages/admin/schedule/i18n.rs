...
translate! {
    ...
    empty: { en: "No scheduled subjects — all caught up.", ko: "예약된 대상이 없습니다." },

    alarm_title: { en: "Queue is running low", ko: "큐가 부족합니다" },
    alarm_body_prefix: { en: "Latest scheduled subject is only", ko: "가장 늦게 예약된 대상이" },
    ...
    alarm_cta: { en: "Schedule a subject", ko: "대상 예약" },

    healthy_title: { en: "Queue healthy", ko: "큐 양호" },
    healthy_count_suffix: { en: "scheduled subjects queued", ko: "건 예약 중" },
