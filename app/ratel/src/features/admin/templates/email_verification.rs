// SES template: email_verification
// Sent by: EmailOperation::SpaceInviteVerification
// Variables: space_title, space_desc, author_profile, author_display_name, author_username, cta_url

#[allow(dead_code)]
pub const SUBJECT: &str = "You're invited to join {{space_title}}";
