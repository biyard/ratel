        ...
        div { class: "w-full max-w-[420px]",
            div { class: "flex flex-col gap-5",
                div { class: "text-center",
                    ...
                    h4 { class: "mb-2 text-lg font-semibold md:text-xl lg:text-2xl text-primary",
                        {tr.receipt_title}
                    }
                ...
                Card {
                    div { class: "flex flex-col gap-4",
                        div { class: "flex justify-between items-center",
                            ...
                            p { class: "font-mono text-sm text-text-primary", {tx_id()} }
                        }
                        ...
                        div { class: "flex justify-between items-center",
                            ...
                            h5 { class: "text-base font-semibold md:text-lg lg:text-xl text-primary",
                                {amount_text()}
                            }
                        }
