use crate::features::social::pages::user_reward::*;

translate! {
    UserRewardsTranslate;

    page_title: { en: "Rewards", ko: "리워드" },
    back: { en: "Back", ko: "뒤로" },
    cycle_label: { en: "Cycle", ko: "사이클" },

    earning_this_cycle: { en: "Earning · this cycle", ko: "이번 사이클 획득" },
    points: { en: "Points", ko: "포인트" },
    share_of_pool: { en: "Share of Pool", ko: "풀 비율" },
    of_total: { en: "of", ko: "/" },
    total_points_unit: { en: "total pts", ko: "전체 pts" },
    your_position: { en: "YOUR POSITION", ko: "내 순위" },
    ...
    source_polls: { en: "Polls", ko: "투표" },
    source_posts: { en: "Posts", ko: "게시글" },
    source_quizzes: { en: "Quizzes", ko: "퀴즈" },
    source_discussions: { en: "Discussions", ko: "토론" },
    source_follows: { en: "Follows", ko: "팔로우" },
    ...
    activity_empty: { en: "No activity yet this cycle.", ko: "아직 활동 내역이 없습니다." },
