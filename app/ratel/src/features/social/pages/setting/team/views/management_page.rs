...
fn MemberRow(
    ...
    rsx! {
        div { class: "flex flex-col {border_class}",
            div { class: "flex relative gap-3 items-center py-3 px-4",
                // Avatar
                if !member.profile_url.is_empty() {
                    ...
                    div { class: "flex justify-center items-center w-9 h-9 rounded-full bg-profile-bg shrink-0",
                ...
                if can_manage && !member.is_owner {
                    div { class: "relative shrink-0",
                        Button {
                            ...
                            class: "flex justify-center items-center w-7 h-7".to_string(),
                            ...
                            div {
                                ...
                                if can_change_role && member.role != TeamRole::Admin {
                                    Button {
                                        ...
                                        size: ButtonSize::Small,
                                        shape: ButtonShape::Square,
                                        class: "flex gap-2 justify-start items-center w-full text-text-primary".to_string(),
                                        onclick: {
