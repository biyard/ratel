                ...
                div { class: "flex flex-col gap-8 w-full",
                    ...
                    div { class: "flex flex-col gap-2 w-full",
                        ...
                        TextArea {
                            ...
                            class: "py-2 px-3 w-full text-sm rounded-lg border resize-y focus:outline-none min-h-[120px] border-input-box-border bg-input-box-bg text-text-primary placeholder:text-foreground-muted focus:border-ring",
                        }
