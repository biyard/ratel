    ...
    rsx! {
        div { class: "w-[420px]",
                ...
                for opt in options.into_iter() {
                    {
                        ...
                        rsx! {
                            button {
                                ...
                                if is_selected {
                                    super::super::icons::validations::CheckCircle { class: "w-5 h-5 [&>circle]:hidden [&>path]:stroke-primary" }
                                }
                            }
                        }
                    }
            ...
            div { class: "flex flex-row gap-4 justify-end mt-4",
                button {
                    class: "px-10 text-base font-bold transition-colors py-[14.5px] bg-cancel-button-bg text-cancel-button-text hover:text-cancel-button-text/80",
                    onclick: on_cancel,
                    "Cancel"
                }
                button {
                    class: "w-full text-base font-bold py-[14.5px] text-submit-button-text rounded-[10px] bg-submit-button-bg hover:bg-submit-button-bg/80",
