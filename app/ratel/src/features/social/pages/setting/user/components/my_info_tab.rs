...
pub fn MyInfoTab(
    username: String,
    profile_url: String,
    on_profile_upload: EventHandler<String>,
    evm_value: String,
    wallet_visible: bool,
    ...
    rsx! {
        div { class: "flex flex-col gap-10 items-center w-full max-tablet:w-full",
            ProfileImageSection { profile_url, on_upload: on_profile_upload }
            SettingsForm {
                username,
                evm_value,
                wallet_visible,
...
pub fn SettingsForm(
    ...
    rsx! {
        div { class: "flex flex-col gap-2.5 w-full",
            div { class: "flex gap-2.5 max-tablet:flex-col",
                label { class: "w-40 font-bold text-text-primary", "Username" }
                input {
                    class: "py-2 px-3 w-full rounded-md border disabled:opacity-70 text-text-primary bg-component-bg border-card-border",
                    r#type: "text",
                    disabled: true,
                    value: "@{username}",
                }
            ...
            div { class: "flex gap-2.5 max-tablet:flex-col",
                ...
                div { class: "flex gap-2 w-full",
                    ...
                    button {
                        class: "py-0 px-4 rounded-sm bg-enable-button-bg text-enable-button-white-text hover:bg-enable-button-bg/80",
            ...
            if wallet_visible {
                div { class: "w-full",
                    div {
                        class: "flex justify-between items-center p-4 rounded-lg transition-colors cursor-pointer bg-card-bg hover:bg-component-bg/70",
            ...
            div { class: "flex gap-2.5 max-tablet:flex-col",
                ...
                input {
                    class: "py-2 px-3 w-full rounded-md border text-text-primary bg-component-bg border-card-border",
                    r#type: "text",
            ...
            div { class: "flex flex-col gap-2.5",
                ...
                textarea {
                    class: "py-2 px-3 w-full rounded-md border resize-y text-text-primary bg-component-bg border-card-border min-h-[120px]",
