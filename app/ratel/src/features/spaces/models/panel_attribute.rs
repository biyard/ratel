...
impl From<PanelAttributeWithQuota> for PanelAttribute {
    fn from(value: PanelAttributeWithQuota) -> Self {
        match value {
    ...
    pub fn to_value(&self) -> Option<String> {
        match self {
            ...
            PanelAttribute::VerifiableAttribute(v) => match v {
                VerifiableAttribute::Age(Age::Specific(age)) => Some(age.to_string()),
