                ...
                if is_creator {
                    Button {
                        ...
                        if can_preview {
                            ...
                            EyeOff { class: "w-4 h-4 [&>path]:stroke-icon-secondary [&>line]:stroke-icon-secondary max-tablet:w-5 max-tablet:h-5 max-tablet:[&>path]:stroke-icon-primary max-tablet:[&>line]:stroke-icon-primary" }
                        }
