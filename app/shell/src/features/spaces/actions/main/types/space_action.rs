...
#[cfg(feature = "server")]
impl From<(crate::features::spaces::actions::discussion::SpacePost, SpaceUserRole)> for SpaceAction {
    fn from((post, role): (crate::features::spaces::actions::discussion::SpacePost, SpaceUserRole)) -> Self {
...
impl From<crate::features::spaces::actions::subscription::SpaceSubscription> for SpaceAction {
    fn from(subscription: crate::features::spaces::actions::subscription::SpaceSubscription) -> Self {
...
impl From<crate::features::spaces::actions::quiz::SpaceQuiz> for SpaceAction {
    fn from(quiz: crate::features::spaces::actions::quiz::SpaceQuiz) -> Self {
