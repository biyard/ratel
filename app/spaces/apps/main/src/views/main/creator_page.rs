        ...
        div { class: "flex flex-col gap-[20px] items-start w-full",
            div { class: "flex flex-col gap-4 w-full",
                div { class: "flex flex-col gap-3 w-full",
                    p { class: "font-bold leading-6 sp-dash-font-raleway text-2xl text-font-primary",
                        {tr.installed_apps}
                    }
                        ...
                        for app_type in installed_apps {
                            {
                                ...
                                let header_action = (!app_type.is_default())
                                    .then(|| {
                                        rsx! {
                                            Button {
                                                class: "flex size-6 items-center justify-center !p-0 rounded-full text-font-body hover:!bg-white/8 hover:!text-font-primary disabled:cursor-not-allowed disabled:opacity-50",
