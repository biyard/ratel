...
export const Privacy = {
  en: {
    ...
    sections: {
      introduction: {
        ...
        content: 'This Privacy Policy explains how Ratel ("we," "us," or "our") collects, uses, discloses, and protects your personal information when you use our survey and deliberation platform. We are committed to protecting your privacy and ensuring the security of your personal data.',
      },
      ...
      dataRetention: {
        ...
        content: 'We retain your personal information for as long as necessary to provide our services and fulfill the purposes outlined in this Privacy Policy. You may request deletion of your account and associated data at any time.',
      },
      yourRights: {
        title: '7. Your Rights',
      ...
      cookies: {
        ...
        content: 'We use cookies and similar tracking technologies to enhance your experience, analyze usage, and personalize content. You can control cookies through your browser settings.',
      },
      thirdPartyLinks: {
  ...
  ko: {
    ...
    sections: {
      introduction: {
        title: '1. 소개',
        content: '본 개인정보처리방침은 Ratel("당사", "우리")이 설문조사 및 숙의 플랫폼을 이용할 때 귀하의 개인정보를 어떻게 수집, 사용, 공개 및 보호하는지 설명합니다. 당사는 귀하의 개인정보를 보호하고 개인 데이터의 보안을 보장하기 위해 최선을 다하고 있습니다.',
      },
      informationCollection: {
        title: '2. 수집하는 정보',
      ...
      informationSharing: {
        title: '4. 정보 공유 및 공개',
        content: '당사는 귀하의 개인정보를 판매하지 않습니다. 다음과 같은 경우 귀하의 정보를 공유할 수 있습니다:',
        items: [
          '귀하의 동의 또는 지시에 따라',
      ...
      dataSecurity: {
        title: '5. 데이터 보안',
        content: '당사는 귀하의 개인정보를 무단 액세스, 변경, 공개 또는 파괴로부터 보호하기 위해 적절한 기술적 및 조직적 조치를 구현합니다. 그러나 인터넷을 통한 전송 방법은 100% 안전하지 않습니다.',
      },
      dataRetention: {
        title: '6. 데이터 보관',
        content: '당사는 서비스를 제공하고 본 개인정보처리방침에 명시된 목적을 달성하는 데 필요한 기간 동안 귀하의 개인정보를 보관합니다. 귀하는 언제든지 계정 및 관련 데이터의 삭제를 요청할 수 있습니다.',
      },
      yourRights: {
        title: '7. 귀하의 권리',
      ...
      cookies: {
        title: '8. 쿠키 및 추적',
        content: '당사는 경험을 향상시키고, 사용을 분석하고, 콘텐츠를 개인화하기 위해 쿠키 및 유사한 추적 기술을 사용합니다. 브라우저 설정을 통해 쿠키를 제어할 수 있습니다.',
      },
      thirdPartyLinks: {
        title: '9. 제3자 링크',
        content: '당사의 플랫폼에는 제3자 웹사이트 또는 서비스에 대한 링크가 포함될 수 있습니다. 당사는 이러한 제3자의 개인정보 보호 관행에 대해 책임을 지지 않습니다. 그들의 개인정보처리방침을 검토할 것을 권장합니다.',
      },
      childrenPrivacy: {
        title: '10. 아동 개인정보 보호',
        content: '당사의 서비스는 13세 미만의 아동을 대상으로 하지 않습니다. 당사는 13세 미만 아동의 개인정보를 고의로 수집하지 않습니다. 당사가 그러한 정보를 수집했다고 생각되면 연락해 주십시오.',
      },
      internationalTransfers: {
        title: '11. 국제 데이터 전송',
        content: '귀하의 정보는 귀하의 거주 국가 이외의 국가로 전송되어 처리될 수 있습니다. 당사는 귀하의 데이터를 보호하기 위해 적절한 안전 조치를 취하고 있습니다.',
      },
      changes: {
        title: '12. 방침 변경',
        content: '당사는 수시로 본 개인정보처리방침을 업데이트할 수 있습니다. 이 페이지에 업데이트된 방침을 게시하고 "최종 업데이트" 날짜를 업데이트하여 중요한 변경 사항을 알려드립니다.',
      },
      contact: {
        title: '13. 문의하기',
        content: '본 개인정보처리방침 또는 당사의 데이터 관행에 대해 질문이나 우려 사항이 있으시면 다음으로 연락해 주십시오:',
        email: '이메일',
        address: '주소',
      },
    },
  ...
  return {
    ...
    sections: {
      ...
      informationCollection: {
        ...
        items: t('sections.informationCollection.items', { returnObjects: true }) as string[],
      },
      howWeUseInfo: {
        title: t('sections.howWeUseInfo.title'),
        content: t('sections.howWeUseInfo.content'),
        items: t('sections.howWeUseInfo.items', { returnObjects: true }) as string[],
      },
      informationSharing: {
        title: t('sections.informationSharing.title'),
        content: t('sections.informationSharing.content'),
        items: t('sections.informationSharing.items', { returnObjects: true }) as string[],
      },
      dataSecurity: {
      ...
      yourRights: {
        ...
        items: t('sections.yourRights.items', { returnObjects: true }) as string[],
      },
      cookies: {
