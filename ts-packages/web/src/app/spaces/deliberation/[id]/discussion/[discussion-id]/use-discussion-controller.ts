...
//   get spaceId() {
//     return this.deps.spaceId;
//   }
//   get discussionId() {
//     return this.deps.discussionId;
//   }
...
//   }
//   changeParticipants = (v: Participant[]) =>
...
//   get data(): UseSuspenseQueryResult<Discussion> {
//     return this.deps.data;
//   }
//   get discussion(): Discussion {
//     return this.deps.discussion;
//   }
//   get users(): DiscussionParticipant[] {
...
//           const incoming = new Set(joinInfo.participants.map((p: any) => p.id));
//           return [
...
//     };
//   }, [meetingSession, users, spaceId, discussionId, get]);
...
//     () => participants.find((p) => p.id === focusedUser?.user_id),
