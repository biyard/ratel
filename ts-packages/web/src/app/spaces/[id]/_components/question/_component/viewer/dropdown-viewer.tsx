    ...
    <div className="flex flex-col w-full gap-2.5">
      ...
      <div className="relative w-65">
        <select
          ...
          className="w-full appearance-none border border-btn-o focus:border-primary px-5 py-[10.5px] pr-10 font-medium text-[15px]/[22.5px] text-neutral-600 light:text-foreground rounded-lg truncate bg-transparent"
        >
