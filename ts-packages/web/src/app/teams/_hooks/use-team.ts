...
export function useTeamPermissions(teamPk: string): TeamPermissions {
  ...
  const adminQuery = useQuery({
    ...
    queryFn: () =>
      teamPk
        ? teamsV3Api.checkTeamPermission(
            teamPk,
            teamsV3Api.TeamGroupPermission.TeamAdmin,
          )
  ...
  const editQuery = useQuery({
    ...
    queryFn: () =>
      teamPk
        ? teamsV3Api.checkTeamPermission(
            teamPk,
            teamsV3Api.TeamGroupPermission.TeamEdit,
          )
        : Promise.resolve({ has_permission: false }),
    enabled: !!teamPk,
    staleTime: 30000,
  ...
  const groupEditQuery = useQuery({
    ...
    queryFn: () =>
      teamPk
        ? teamsV3Api.checkTeamPermission(
            teamPk,
            teamsV3Api.TeamGroupPermission.GroupEdit,
          )
        : Promise.resolve({ has_permission: false }),
    enabled: !!teamPk,
    staleTime: 30000,
  ...
  const postWriteQuery = useQuery({
    ...
    queryFn: () =>
      teamPk
        ? teamsV3Api.checkTeamPermission(
            teamPk,
            teamsV3Api.TeamGroupPermission.PostWrite,
          )
        : Promise.resolve({ has_permission: false }),
    enabled: !!teamPk,
    staleTime: 30000,
  ...
  const postEditQuery = useQuery({
    ...
    queryFn: () =>
      teamPk
        ? teamsV3Api.checkTeamPermission(
            teamPk,
            teamsV3Api.TeamGroupPermission.PostEdit,
          )
        : Promise.resolve({ has_permission: false }),
    enabled: !!teamPk,
    staleTime: 30000,
  ...
  const postDeleteQuery = useQuery({
    ...
    queryFn: () =>
      teamPk
        ? teamsV3Api.checkTeamPermission(
            teamPk,
            teamsV3Api.TeamGroupPermission.PostDelete,
          )
        : Promise.resolve({ has_permission: false }),
    enabled: !!teamPk,
    staleTime: 30000,
  ...
  return {
    ...
    canManageMembers:
      groupEditQuery.data?.has_permission ||
      adminQuery.data?.has_permission ||
      false,
