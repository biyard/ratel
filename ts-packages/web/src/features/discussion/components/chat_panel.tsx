...
export default function ChatPanel({
  ...
  onClose: () => void;
  users: DiscussionParticipantResponse[];
          ...
          return (
            <div key={i}>
              ...
              >
                ...
                >
                  {!isMe &&
                    (senderInfo?.author_profile_url ? (
                      <img
                        src={senderInfo.author_profile_url}
                        alt={`${senderInfo?.author_username ?? 'user'}'s profile`}
...
function getParticipantInfo(
  ...
  if (!user) return null;
  const participant = participants.find((p) => p.user_pk === user.user_pk);
