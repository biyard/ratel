...
test.describe('Create Post Page - Authenticated User', () => {
  ...
  test('[CP-AUTH-001] should display create post form with all elements', async ({
    ...
    const editor = page.getByLabel('post-content-editor');
  ...
  test('[CP-AUTH-002] should create a new post successfully', async ({
    ...
    // Fill in content
    await fill(page, { label: 'post-content-editor' }, testContent);
  ...
  test('[CP-AUTH-011] should load existing post when postPk is provided', async ({
    ...
    await fill(page, { label: 'post-content-editor' }, createContent);
  ...
  test('[CP-AUTH-013] should handle mobile responsive layout', async ({
    ...
    await expect(page.getByLabel('post-content-editor')).toBeVisible();
