  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <button className="flex justify-between items-center w-[150px] border border-c-wg-70 rounded-lg px-[20px] py-[10.5px] font-medium text-neutral-600 border-[#525252] light:border-create-space-border bg-create-space-bg text-[15px]/[22.5px] text-left shadow-sm focus:outline-none gap-[10px]">
          {selectedTime || 'Select'}
