...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "bg-input-box-bg border-neutral-600 text-text-primary\
        data-[placeholder]:text-text-secondary [&_svg:not([class*='text-'])]:text-muted-foreground\
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn('text-white px-2 py-1.5 text-xs', className)}
      {...props}
    />
  );
}
