...
- **When making accessibility props optional with `#[props(default)]`**, add `#[cfg(debug_assertions)]` warnings (e.g., `tracing::debug!`) to surface missing values during development without breaking existing call sites
