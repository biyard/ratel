...
awslocal dynamodb create-table --cli-input-json ./scripts/dynamodb-schema.json
echo 'ratel-local-main table and GSIs created successfully'
awslocal dynamodb create-table --cli-input-json ./scripts/dynamodb-session-schema.json
