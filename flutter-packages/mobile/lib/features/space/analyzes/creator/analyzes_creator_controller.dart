...
class AnalyzesCreatorController extends BaseController {
  ...
  void onInit() {
    super.onInit();
    logger.d('AnalyzesCreatorController initialized');

    final rawPk = Get.parameters['spacePk'];
    if (rawPk == null || rawPk.isEmpty) {
      logger.w(
        'AnalyzesCreatorController: spacePk is null or empty in parameters',
      );
      return;
    }
...
extension AnalyzesCreatorControllerX on AnalyzesCreatorController {
