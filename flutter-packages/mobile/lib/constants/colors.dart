...
abstract class AppColors {
  ...
  static const Color cbText = Color(0xffaeaaab);

  static const Color borderPrimary = Color(0xff464646);

  static const Color btnP = Color(0xfffcb300);
  static const Color btnPHover = Color(0xffca8f00);
  static const Color btnPText = black;
  static const Color btnPHoverText = black;
  static const Color btnPDisabled = Color(0xff777677);
  static const Color btnPDisabledText = Color(0xffaeaeae);

  static const Color btnS = Color(0xffffffff);
  static const Color btnSHover = Color(0xffcccccc);
  static const Color btnSText = black;
  static const Color btnSHoverText = black;
  static const Color btnSDisabled = Color(0xff777677);
  static const Color btnSDisabledText = Color(0xffaeaeae);

  static const Color btnO = Color(0xff464646);
  static const Color btnOHover = Color(0xffffffff);
  static const Color btnOHoverBg = Color(0xff1a1a1a);
  ...
  static const Color btnCWg70 = Color(0xff464646);
  static const Color btnCWg80 = Color(0xff323232);
  ...
  static const Color componentBg = Color(0xff191919);
}
