...
use dioxus::prelude::*;
use dioxus_primitives_core::dioxus_attributes::attributes;
use dioxus_primitives_core::merge_attributes;
use dioxus_primitives_core::use_controlled;
        ...
        Tooltip {
            ...
            TooltipContent {
                side: match sidebar_side() {
                    SidebarSide::Left => dioxus_primitives_core::ContentSide::Right,
                    SidebarSide::Right => dioxus_primitives_core::ContentSide::Left,
                },
                {tooltip_content}
            }
        }
