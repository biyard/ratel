...
참여자용 요약은 [팀 만들기 → 하위팀](./teams#%ED%95%98%EC%9C%84%ED%8C%80) 에 있어요. 이 챕터는 모든 URL 의 심층 가이드입니다.
...
- [팀 설정](./team-settings) — 구독 카드를 포함한 Team 자체 설정의 관리자 도구.
- [멤버십](./membership) — Team 의 보상 스페이스를 펀딩할 Credit 등급을 선택하세요.
