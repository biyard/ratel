...
pub mod list_space_dao_selected;
pub use list_space_dao_selected::*;

pub mod create_space_dao_selected;
pub use create_space_dao_selected::*;
...
pub mod update_space_dao_selected;
pub use update_space_dao_selected::*;
...
pub fn route() -> Router<AppState> {
    Router::new()
        ...
        .route(
            "/selected",
            get(list_space_dao_selected_handler)
                .post(create_space_dao_selected_handler)
                .patch(update_space_dao_selected_handler),
        )
