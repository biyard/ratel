...
use crate::{
    models::dynamo_tables::main::user::User, types::Membership,
...
pub async fn get_user_membership(
    ...
    Ok(Json(UserInfo {
        ...
        membership_type: user.membership_info.membership_type,
        membership_active: user.membership_info.is_active(),
    }))
}
