      ...
      <tr><td align="center">
        <table role="presentation" width="560" cellspacing="0" cellpadding="0" style="background:#fff;border-radius:14px;padding:24px">
          <tr><td>
            ...
            <h2 style="margin:18px 0 10px; color:#171717; font-size:20px; font-weight:600">You're invited to join {space}</h2>
            ...
            <div style="color:#262626; font-size:13px; font-weight:400">{user} invited you to join {space}.</div>
            ...
            <div class="card">
              <div style="font-weight:700;margin-bottom:10px;color:#171717;">{space_title}</div>
              <p style="
                margin:0 0 10px;
                color:#8c8c8c;
                display:-webkit-box;
            ...
            <p style="color:#262626;font-size:11px">
              If the button doesn’t work, use this link: <a href="{cta_url}">{cta_url}</a>
            </p>
