pub const CREATE_SPACE_POST_TEMPLATE_SUBJECT: &str = "New content posted in your space";

pub const CREATE_SPACE_POST_TEMPLATE_HTML: &str = r#"<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8">
        ...
        <table role="presentation" width="560" cellspacing="0" cellpadding="0" style="background:#fff;border-radius:14px;padding:24px">
          <tr><td>
            ...
            <h2 style="margin:18px 0 10px; color:#171717; font-size:20px; font-weight:600">
              Space members are posting new space contents.
            </h2>
