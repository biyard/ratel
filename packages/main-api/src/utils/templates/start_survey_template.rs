pub const START_SURVEY_TEMPLATE_SUBJECT: &str = "New survey in {{space_title}}";

pub const START_SURVEY_TEMPLATE_HTML: &str = r#"<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>New survey in {{space_title}}</title>
        ...
        <table role="presentation" width="560" cellspacing="0" cellpadding="0" style="background:#fff;border-radius:14px;padding:24px">
          <tr><td>
            ...
            <h2 style="margin:18px 0 10px; color:#171717; font-size:20px; font-weight:600">
              New survey started in {{space_title}}
            </h2>
            ...
            <div class="card">
              <div style="font-weight:700;margin-bottom:6px;color:#171717;font-size:15px;">
                {{survey_title}}
              </div>
            </div>

            <p style="color:#262626;font-size:11px;margin-top:16px;">
              If the button doesn’t work, use this link:
              <a href="{{connect_link}}">{{connect_link}}</a>
            </p>
            ...
            <p style="margin-top:24px; text-align:center;">
              <a href="{{connect_link}}"
                 style="display:inline-block;padding:12px 12px;border-radius:10px;
                        ...
                        font-weight:700;">
                <span style="color:#000 !important;">Start Survey</span>
              </a>
            </p>
