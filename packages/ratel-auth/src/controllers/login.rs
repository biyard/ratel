...
pub async fn login_with_phone(
    ...
    let now = common::utils::time::get_now_timestamp();
...
pub async fn login_with_email(
    ...
    let hashed_password = common::utils::password::hash_password(&password);
...
// ) -> Result<User> {
//     let telegram_user =
//         common::utils::telegram::parse_telegram_raw(telegram_raw.clone()).map_err(|e| {
