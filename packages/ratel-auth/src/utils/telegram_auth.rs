...
pub fn parse_telegram_raw(telegram_raw: String, telegram_token: &str) -> std::result::Result<TelegramUser, String> {
    ...
    validation_result.ok_or_else(|| "Failed to validate and parse Telegram data".to_string())
}
