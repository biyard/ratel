...
#[component]
pub fn Checkbox(#[props(default ="".to_string())] class: String, title: String) -> Element {
    ...
    rsx! {
        div {
            ...
            div {
                class: "flex flex-row items-center justify-start gap-[6px] cursor-pointer",
                CheckboxIcon { checked: checked() }
                span {
                    class: "text-[16px] font-bold leading-[24px] text-white",
                    "{title}"
                }
            }
        }
