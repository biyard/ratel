...
pub fn HomePage(lang: Language) -> Element {
    ...
    rsx! {
        div {
            class: "flex flex-col gap-[100px] grid grid-cols-1 mb-[20px]",
            HighlightedTopics {
                class: "col-span-1",
            ...
            div {
                class: "col-span-1 w-full flex flex-row items-start justify-center gap-x-[20px] gap-y-[60px] grid grid-cols-2 max-[1000px]:grid-cols-1",
                FinishedTopics {
                    class: "col-span-1",
