...
use bdk::prelude::*;
use dto::{ContentType, News, NewsQuery, NewsSummary, Promotion, Space, User, Follower};
use dto::{LandingData};
...
pub struct Controller {
    ...
    pub my_followers: Resource<Vec<FollowerPerson>>,
}
...
impl Controller {
    pub fn new(lang: Language) -> std::result::Result<Self, RenderError> {
        ...
        let my_followers= use_server_future(move || async move {
            vec![
                FollowerPerson {
                    id: 1,
                    name: "Jongseok Park".to_string(),
                    image_url: "https://lh3.googleusercontent.com/a/ACg8ocIGf0gpB8MQdGkp5TXW1327nRpuPz70iy_hQY2NXNwanRXbFw=s96-c".to_string(),
                    about: "Office of Rep.".to_string(),
                    followed: true,
                },
                FollowerPerson {
                    id: 2,
                    ...
                    image_url: "https://lh3.googleusercontent.com/a/ACg8ocIGf0gpB8MQdGkp5TXW1327nRpuPz70iy_hQY2NXNwanRXbFw=s96-c".to_string(),
                    about: "Software Engineer".to_string(),
                    followed: false,
                },
                FollowerPerson {
                    id: 3,
                    ...
                    image_url: "https://lh3.googleusercontent.com/a/ACg8ocIGf0gpB8MQdGkp5TXW1327nRpuPz70iy_hQY2NXNwanRXbFw=s96-c".to_string(),
                    about: "Product Manager".to_string(),
                    followed: true,
                },
            ]
        })?;

        let my_following: Resource<Vec<User>> = use_server_future(move || async move {
            Vec::new()
        })?;
