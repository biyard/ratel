...
pub fn BottomSheet(
    ...
    rsx! {
        div { class: "hidden max-tablet:flex max-tablet-flex-row max-tablet:justify-between max-tablet:items-center max-tablet:px-16 max-tablet:pt-12 max-tablet:pb-22 max-tablet:bg-neutral-800",
            BottomIcon {
                icon: rsx! {
                    Internet {
                        class: format!(
