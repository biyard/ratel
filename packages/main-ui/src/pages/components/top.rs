    ...
    rsx! {
        div {
            ...
            div { class: "flex flex-col items-center justify-center gap-[32px]",
                ...
                h1 { class: "text-[28px] text-center font-bold leading-[56px] text-white whitespace-pre-line",
                    {tr.slogan}
                }
            ...
            div { class: "w-full flex flex-col justify-center items-center gap-[16px] ",
                // TODO: implement downloading whitepaper
                div { class: "w-[291px] h-[48px] flex justify-center items-center rounded-[10px] bg-[#FCB300] p-[20px]",
                    PrimaryButton {
                        onclick: |_| {},
